...
async def analyze_image_url(
    ...
    try:
        ...
        # Perform analysis
        detected_objects, image_metadata, processing_time = await cv_service.analyze_image_from_url(
...
async def analyze_uploaded_image(
    ...
    include_metadata: bool = Form(True, description="Include image metadata in response"),
    cv_service: ComputerVisionService = Depends(get_computer_vision_service),
    authorized: bool = Depends(verify_api_key)
) -> AnalysisResult:
    ...
    try:
        ...
        # Perform analysis
        detected_objects, image_metadata, processing_time = await cv_service.analyze_image_from_stream(
            image_data,
            confidence_float,
            max_objects
        )
